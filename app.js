...
// --- GLOBAL STATE & CONFIG ---
// This will be populated by the firebase-config.js script generated by Vercel
...
async function initialize() {
    try {
        if (!window.firebaseConfig) {
            console.error("Firebase config not loaded. Waiting...");
            setTimeout(initialize, 100); // Wait and retry
            return;
        }
